...
export const handlers = [
  ...
  http.get('/api/trends', ({ request, params }) => {
    return HttpResponse.json([
      ...
      { tagId: 2, title: '원', count: 1264 },
      { tagId: 3, title: '투', count: 1264 },
      { tagId: 4, title: '쓰리', count: 1264 },
      { tagId: 5, title: '포', count: 1264 },
      { tagId: 6, title: '파이브', count: 1264 },
      { tagId: 7, title: '식스', count: 1264 },
      { tagId: 8, title: '세븐', count: 1264 },
      { tagId: 9, title: '에잇', count: 1264 },
      { tagId: 10, title: '나인', count: 1264 },
    ]);
  }),
];
